...
export type NativeImagePreviewDemoItem = {
  alt: string;
  height: number;
  id: string;
  label: string;
...
const portraitSource = require('../../../assets/native-image-preview/portrait.png') as ImageSourcePropType;
const mountainSource = require('../../../assets/native-image-preview/mountain.png') as ImageSourcePropType;
const wideSource = require('../../../assets/native-image-preview/wide.png') as ImageSourcePropType;
const valleySource = require('../../../assets/native-image-preview/valley.png') as ImageSourcePropType;
const flowerSource = require('../../../assets/native-image-preview/flower.png') as ImageSourcePropType;
const riverSource = require('../../../assets/native-image-preview/river.png') as ImageSourcePropType;
...
export const nativeImagePreviewDemoItems: NativeImagePreviewDemoItem[] = [
