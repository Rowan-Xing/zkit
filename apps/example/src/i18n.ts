...
const zhCN: I18nMessages = {
  ...
  'example.surfaces.accordionServicesBody': 'Toast、Dialog、Loading、Picker、权限说明、图片预览、裁剪与验证码共享一个根 Provider。',
  ...
  'example.services.cropperSubtitle': '原生裁剪',
  ...
  'example.services.otaTitle': 'OTA 更新',
  'example.services.otaSubtitle': '模拟热更新',
