...
const enUS = {
  ...
  'example.surfaces.multipleLazyTitle': 'Multiple + filled + lazy',
  ...
  'example.surfaces.compactAccordionTitle': 'Custom item gap and small size',
  'example.surfaces.compactAccordionDescription': 'itemGap / size / tone',
...
const zhCN = {
  ...
  'example.surfaces.multipleLazyTitle': '多选 + filled + lazy',
  'example.surfaces.multipleLazyDescription': 'type="multiple"',
  'example.surfaces.multipleLazyBody': '多选模式可同时展开多个项目，lazy 内容会延迟挂载，减少初次渲染负担。',
  'example.surfaces.compactAccordionTitle': '自定义间距与小尺寸',
  'example.surfaces.compactAccordionDescription': 'itemGap / size / tone',
