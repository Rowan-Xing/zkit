...
const enUS: I18nMessages = {
  ...
  'example.surfaces.accordionServicesBody': 'Toast, dialog, loading, picker, permission purpose, image preview, cropper, and captcha share one root provider.',
  ...
  'example.services.cropperTitle': 'Image cropper',
  'example.services.cropperSubtitle': 'native photo crop',
  'example.services.cropperEdit': 'Edit Photo',
  'example.services.cropperSuccess': 'Image cropped',
  'example.services.cropperFailed': 'Crop failed',
  ...
  'example.services.otaTitle': 'OTA manager',
  'example.services.otaSubtitle': 'dev simulation',
  'example.services.otaRelease': 'OTA checks run in release builds',
...
const zhCN: I18nMessages = {
  ...
  'example.header.subtitle': '组件库与工具库功能展示，面向高性能原生页面、细腻动效和 Provider 服务流。',
  'example.header.previewLabel': '应用原型界面',
  'example.header.previewValue': '移动端优先',
  'example.metric.uiModules': 'UI 模块',
  'example.metric.toolExports': '工具导出',
  'example.metric.motionTarget': '动效目标',
  ...
  'example.permission.message': '用于当前应用中的图片拍摄和裁剪流程。',
  ...
  'example.foundation.subtitle': '文本、颜色、缩放和加载基础能力',
  'example.foundation.displayLabel': '展示',
  'example.foundation.displayText': '速度克制，控制清晰。',
  'example.foundation.displaySubtitle': '正文保持可读，状态变化保持即时。',
  ...
  'example.actions.subtitle': '实心、柔和、描边、幽灵、纯图标和加载模式',
  'example.actions.panelTitle': '主操作区域',
  'example.actions.panelSubtitle': '按钮在加载和按压状态下保持稳定触控尺寸。',
  ...
  'example.forms.subtitle': 'TextInput、Switch、禁用态与行内反馈',
  ...
  'example.choice.title': '选择状态模型',
  'example.choice.subtitle': '受控 CheckboxGroup 和 RadioGroup，统一 value 命名',
  ...
  'example.surfaces.subtitle': 'Accordion、BottomSheet 与联动滚动模式',
  'example.surfaces.accordionState': '受控与非受控状态',
  'example.surfaces.accordionStateBody': '按钮、开关、复选组、单选组和选择器都接入了本页本地状态。',
  'example.surfaces.accordionServices': 'Provider 驱动的浮层',
  'example.surfaces.accordionServicesBody': 'Toast、Dialog、Loading、Picker、权限说明、图片预览、裁剪和验证码共享同一个根 Provider。',
  'example.surfaces.linkedTitle': '菜单与内容联动滚动',
  'example.surfaces.linkedBody': '两个 FlashList 面板与父级页面隔离滚动。',
  'example.surfaces.sheetTitle': 'BottomSheet',
  'example.surfaces.sheetBody': '原生弹层档位与紧凑内容。',
  'example.surfaces.sheetSubtitle': '档位、原生手势和稳定内容尺寸。',
  'example.surfaces.detent': '档位',
  'example.surfaces.max': '最大',

  'example.pickers.eyebrow': '选择器',
  'example.pickers.title': '选择器流程',
  'example.pickers.subtitle': '单列、树形、日期、地址和日期区间',
  'example.pickers.language': '语言',
  'example.pickers.workflow': '工作流',

  'example.services.eyebrow': '服务',
  'example.services.title': 'Provider 驱动操作',
  'example.services.subtitle': '由 ComponentLibProvider 挂载的全局浮层与命令式 API',
  'example.services.toastTitle': 'Toast',
  'example.services.toastSubtitle': '成功 / 警告 / 错误 / 信息',
  'example.services.toastSaved': '已通过 Toast 保存',
  'example.services.dialogTitle': 'ActionDialog',
  'example.services.dialogSubtitle': '确认流程',
  'example.services.loadingTitle': 'Loading',
  'example.services.loadingSubtitle': '绑定 Promise 结果',
  'example.services.pickerTitle': 'Picker 服务',
  ...
  'example.services.cropperTitle': '图片裁剪',
  'example.services.cropperSubtitle': '原生照片裁剪',
  'example.services.cropperEdit': '编辑照片',
  'example.services.cropperSuccess': '图片已裁剪',
  'example.services.cropperFailed': '裁剪失败',
  'example.services.captchaTitle': '滑块验证',
  'example.services.captchaSubtitle': '挑战校验',
  'example.services.debuggerTitle': '悬浮调试器',
  'example.services.debuggerSubtitle': '日志与网络面板',
  'example.services.otaTitle': 'OTA 管理器',
  'example.services.otaSubtitle': '开发模拟',
  'example.services.otaRelease': 'OTA 检查会在 Release 包中运行',

  'example.tools.eyebrow': '工具',
  'example.tools.title': '运行时工具',
  'example.tools.subtitle': '屏幕缩放、字体缩放、设备品牌、环境变量和路由防抖',
  ...
  'example.linked.summary.overview': '概览区块，内容更密集，目标视口更高。',
  'example.linked.summary.media': '类媒体区块，混合文案、标签和非等高内容。',
  'example.linked.summary.metrics': '指标区块，行内容紧凑，回收类型可预测。',
