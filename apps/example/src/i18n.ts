...
const enUS = {
  ...
  'example.forms.subtitle': 'Input patterns, feedback states, and switch controls',
  'example.forms.inputGroupTitle': 'Common input',
  'example.forms.inputGroupCaption': 'Search, controlled note, and numeric entry',
  'example.forms.feedbackGroupTitle': 'Feedback and long text',
  'example.forms.feedbackGroupCaption': 'Validation, warning tone, and multiline sizing',
  'example.forms.stateGroupTitle': 'States and switches',
  'example.forms.stateGroupCaption': 'Read-only, disabled, busy, and boolean controls',
  'example.forms.searchLabel': 'Search',
  'example.forms.searchValue': 'TextInput',
  'example.forms.searchPlaceholder': 'Search components',
  'example.forms.searchDescription': 'Search keyboard / leading icon / clearable',
  ...
  'example.forms.amountLabel': 'Amount',
  'example.forms.amountDescription': 'prefix / suffix / filled / success',
  'example.forms.validationValue': 'Too short',
  'example.forms.validationLabel': 'Validation',
  'example.forms.validationError': 'This field shows status=error and helper copy.',
  'example.forms.multilineValue': 'Multiline content with minRows, maxRows, warning tone, and custom row sizing.',
  'example.forms.multilineLabel': 'Multiline',
  'example.forms.multilineDescription': 'minRows=3 / maxRows=5 / outline',
  'example.forms.readOnlyValue': 'Read only',
  'example.forms.readOnlyLabel': 'ReadOnly',
  'example.forms.disabledValue': 'Disabled',
  'example.forms.disabledLabel': 'Disabled',
  'example.forms.switchSmallInfo': 'Small info',
  'example.forms.switchLabelPlacementEnd': 'labelPlacement=end',
  'example.forms.switchOnShort': 'ON',
  'example.forms.switchOffShort': 'OFF',
  'example.forms.switchLoading': 'Loading',
  'example.forms.switchBusyState': 'busy state',
  'example.forms.switchDisabled': 'Disabled',
  'example.forms.switchNotInteractive': 'not interactive',
  'example.forms.switchCustom': 'Custom',

  'example.choice.eyebrow': 'Choice',
  'example.choice.title': 'Selection model',
  'example.choice.subtitle': 'Controlled and uncontrolled states, variants, disabled behavior, and custom content',
  ...
  'example.choice.compactDescription': 'Dense lists and tool rows',
  'example.choice.comfortableDescription': 'Default form rhythm',
  'example.choice.spaciousDescription': 'Relaxed setting screens',
  'example.choice.checkboxStates': 'Checkbox states',
  'example.choice.checkboxStatesCaption': 'Checked, unchecked, indeterminate, disabled, shape, size, and variant in one matrix.',
  'example.choice.checkboxGroupCaption': 'A controlled value array with tri-state select-all and item-level overrides.',
  'example.choice.radioStates': 'Radio states',
  'example.choice.radioGroupCaption': 'A controlled single value with group-level defaults and item overrides.',
  'example.choice.radioStatesCaption': 'Standalone radios cover checked, allowDeselect, disabled, large soft, and custom content.',
  'example.choice.checked': 'Checked',
  'example.choice.defaultChecked': 'defaultChecked',
  'example.choice.indeterminate': 'Indeterminate',
  'example.choice.warningSolid': 'warning / solid',
  'example.choice.unchecked': 'Unchecked',
  'example.choice.outline': 'outline',
  'example.choice.outlineCircle': 'Outline circle',
  'example.choice.shapeCircle': 'shape=circle',
  'example.choice.solidCircle': 'Solid circle',
  'example.choice.solidCircleDescription': 'solid / circle',
  'example.choice.infoSoft': 'info / soft',
  'example.choice.softLg': 'Soft / lg',
  'example.choice.disabled': 'Disabled',
  'example.choice.lockedState': 'locked state',
  'example.choice.standalone': 'standalone',
  'example.choice.allowDeselect': 'Allow deselect',
  'example.choice.tapAgainToClear': 'tap again to clear',
  'example.choice.warningSoft': 'warning / soft',
  'example.choice.selectAll': 'Select all',
  'example.choice.selectAllDescription': 'Controlled indeterminate state follows the group value.',
  'example.choice.groupItemPrimary': 'inherits group variant',
  'example.choice.groupItemOverride': 'item overrides tone',
  'example.choice.groupItemDisabled': 'disabled item',
  'example.choice.customCheckboxCard': 'Custom checkbox content',
  'example.choice.customCheckboxCardDescription': 'showIndicator=false with render-prop children',
  'example.choice.customRadioCard': 'Custom radio content',
  'example.choice.customRadioCardDescription': 'showIndicator=false with render-prop children',
...
const zhCN = {
  ...
  'example.forms.subtitle': '输入场景、反馈状态与开关控制',
  'example.forms.inputGroupTitle': '常用输入',
  'example.forms.inputGroupCaption': '搜索、备注与数值录入',
  'example.forms.feedbackGroupTitle': '反馈与长文本',
  'example.forms.feedbackGroupCaption': '校验、警告语义与多行高度',
  'example.forms.stateGroupTitle': '状态与开关',
  'example.forms.stateGroupCaption': '只读、禁用、忙碌与布尔控制',
  'example.forms.searchLabel': '搜索',
  'example.forms.searchValue': 'TextInput',
  'example.forms.searchPlaceholder': '搜索组件',
  'example.forms.searchDescription': '搜索键盘 / 前置图标 / 可清空',
  ...
  'example.forms.amountLabel': '金额',
  'example.forms.amountDescription': '前缀 / 后缀 / filled / success',
  'example.forms.validationValue': '内容过短',
  'example.forms.validationLabel': '校验',
  'example.forms.validationError': '此输入框展示 status=error 与错误说明。',
  'example.forms.multilineValue': '这是多行内容，用来展示 minRows、maxRows、warning 语义和自定义行高。',
  'example.forms.multilineLabel': '多行输入',
  'example.forms.multilineDescription': 'minRows=3 / maxRows=5 / outline',
  'example.forms.readOnlyValue': '只读内容',
  'example.forms.readOnlyLabel': '只读',
  'example.forms.disabledValue': '禁用内容',
  'example.forms.disabledLabel': '禁用',
  'example.forms.switchSmallInfo': '小尺寸信息',
  'example.forms.switchLabelPlacementEnd': '文案在右侧',
  'example.forms.switchOnShort': '开',
  'example.forms.switchOffShort': '关',
  'example.forms.switchLoading': '加载中',
  'example.forms.switchBusyState': '忙碌状态',
  'example.forms.switchDisabled': '禁用',
  'example.forms.switchNotInteractive': '不可交互',
  'example.forms.switchCustom': '自定义',

  'example.choice.eyebrow': '选择',
  'example.choice.title': '选择模型',
  'example.choice.subtitle': '覆盖受控、非受控、三态、外观、禁用与自定义内容',
  ...
  'example.choice.compactDescription': '密集列表与工具行',
  'example.choice.comfortableDescription': '默认表单节奏',
  'example.choice.spaciousDescription': '宽松设置界面',
  'example.choice.checkboxStates': 'Checkbox 状态',
  'example.choice.checkboxStatesCaption': '一次展示已选、未选、半选、禁用、形状、尺寸和变体。',
  'example.choice.checkboxGroupCaption': '受控 value 数组，包含三态全选与单项覆盖。',
  'example.choice.radioStates': 'Radio 状态',
  'example.choice.radioGroupCaption': '受控单值，展示组级默认外观与单项覆盖。',
  'example.choice.radioStatesCaption': '独立 Radio 覆盖已选、可取消、禁用、大尺寸柔和态与自定义内容。',
  'example.choice.checked': '已选',
  'example.choice.defaultChecked': '默认选中',
  'example.choice.indeterminate': '半选',
  'example.choice.warningSolid': 'warning / 实心',
  'example.choice.unchecked': '未选',
  'example.choice.outline': '描边',
  'example.choice.outlineCircle': '圆形描边',
  'example.choice.shapeCircle': 'shape=circle',
  'example.choice.solidCircle': '圆形实心',
  'example.choice.solidCircleDescription': 'solid / circle',
  'example.choice.infoSoft': 'info / 柔和',
  'example.choice.softLg': '柔和 / 大尺寸',
  'example.choice.disabled': '禁用',
  'example.choice.lockedState': '锁定状态',
  'example.choice.standalone': '独立使用',
  'example.choice.allowDeselect': '允许取消选择',
  'example.choice.tapAgainToClear': '再次点击可清空',
  'example.choice.warningSoft': 'warning / 柔和',
  'example.choice.selectAll': '全选',
  'example.choice.selectAllDescription': '受控半选态跟随组值变化。',
  'example.choice.groupItemPrimary': '继承组级变体',
  'example.choice.groupItemOverride': '单项覆盖 tone',
  'example.choice.groupItemDisabled': '单项禁用',
  'example.choice.customCheckboxCard': '自定义 Checkbox 内容',
  'example.choice.customCheckboxCardDescription': 'showIndicator=false + render-prop children',
  'example.choice.customRadioCard': '自定义 Radio 内容',
  'example.choice.customRadioCardDescription': 'showIndicator=false + render-prop children',
